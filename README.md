...
## mudar android
para mudar o apk e colocar o seu ip é só pegar um app como apk editor ou apk tool para editar e no assets/serv.txt trocar de **192.198.3.37** pelo seu ip local de wifi do seu pc/celular. codigo fonte em [aqui](github.com/lucazinho1002/bw-launcher2-andr.)

## mudar pc
vá em recources, app e depois src, dai va em index.html e mude tudo de **192.198.3.37** pelo seu ip local de wifi do seu pc/celular. codigo fonte em [aqui](github.com/lucazinho1002/bw-launcher2-pc).
